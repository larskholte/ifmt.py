...
if __name__ == '__main__':
    ...
    parser.add_argument('input',metavar='input',type=argparse.FileType('r'),help='Input file. If "-", STDIN is read.') # Input file
    parser.add_argument('-o','--output',dest='output',metavar='output',type=argparse.FileType('w'),default=sys.stdout,help='Output file. If unspecified, output is written to STDOUT.') # Output file
